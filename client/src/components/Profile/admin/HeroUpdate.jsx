...
function HeroUpdate({ hero, close, category }) {
  ...
  return (
    <div className="relative bg-white p-8 rounded-2xl shadow-xl  mx-auto mt-16 border border-[#d58a94]">
      {loading && (
      ...
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-bold text-black">Update Hero</h2>
        <button
          onClick={close}
          type="button"
          className="text-black bg-[#d58a94] hover:bg-[#c57a84] px-4 py-1 rounded-md transition"
        >
          Close
        </button>
      </div>
